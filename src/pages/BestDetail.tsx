import bestBooks from "../data/Best.ts";
import type { BestBooksType } from "../data/Best.ts";
...
const NewDetail = () => {
  ...
  const book: BestBooksType | null = bestBooks.find(item => item.id === parseInt(id)) ?? null;
  if (!book) {
